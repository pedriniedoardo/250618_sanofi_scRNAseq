# AIM ---------------------------------------------------------------------
# explore the expression of FTL in the shafflick blood dataset
...
data.combined <- readRDS("../out/object/013_schafflick_blood_full.rds")
...
df_avg %>%
  write_tsv("../out/table/013_avg_exp_FTL_shafflick_blood.tsv")
